...
def clear_old_tasks():
    ...
    """
    Say("Do you want to clear old tasks? Please Enter YES or NO.")
...
#     """
#     Handle user queries for scheduling and showing tasks.
#     """
#     query = query.lower()
#     if "schedule my day" in query:
#         clear_old_tasks()
...
#
#
# # Main loop to listen to user queries and handle them
# while True:
#     query = Listen()
#     handle_query(query)
